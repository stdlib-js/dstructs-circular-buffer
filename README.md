...
```javascript
circularBuffer = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/dstructs-circular-buffer@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/dstructs-circular-buffer/tags). For example,

```javascript
circularBuffer = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/dstructs-circular-buffer@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var circularBuffer = require( 'path/to/vendor/umd/dstructs-circular-buffer/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/dstructs-circular-buffer@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/dstructs-circular-buffer.svg
[npm-url]: https://npmjs.org/package/@stdlib/dstructs-circular-buffer

[test-image]: https://github.com/stdlib-js/dstructs-circular-buffer/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/dstructs-circular-buffer/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/dstructs-circular-buffer/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/dstructs-circular-buffer?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/dstructs-circular-buffer.svg
[dependencies-url]: https://david-dm.org/stdlib-js/dstructs-circular-buffer/main
...
[deno-url]: https://github.com/stdlib-js/dstructs-circular-buffer/tree/deno
[deno-readme]: https://github.com/stdlib-js/dstructs-circular-buffer/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/dstructs-circular-buffer/tree/umd
[umd-readme]: https://github.com/stdlib-js/dstructs-circular-buffer/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/dstructs-circular-buffer/tree/esm
[esm-readme]: https://github.com/stdlib-js/dstructs-circular-buffer/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/dstructs-circular-buffer/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/dstructs-circular-buffer/main/LICENSE
...
[@stdlib/dstructs/fifo]: https://github.com/stdlib-js/dstructs-fifo/tree/umd

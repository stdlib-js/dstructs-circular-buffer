...
```javascript
circularBuffer = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/dstructs-circular-buffer@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/dstructs-circular-buffer/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/dstructs-circular-buffer/actions/workflows/test.yml?query=branch:v0.1.1
